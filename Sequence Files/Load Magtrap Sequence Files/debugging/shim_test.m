...
if test_MOT
    ...
    setAnalogChannel(calctime(curtime,0),'X MOT Shim',x_shim_val,1); %0.2
    setAnalogChannel(calctime(curtime,0),'Y MOT Shim',y_shim_val,1); %2.0
    setAnalogChannel(calctime(curtime,0),'Z MOT Shim',z_shim_val,1); %0.9
