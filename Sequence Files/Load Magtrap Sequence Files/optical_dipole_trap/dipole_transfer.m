...
if ( seqdata.flags.CDT_evap == 1 && seqdata.flags.xdt_evap2stage)
    ...
    if (seqdata.flags.xdt_evap2_HF == 1 && seqdata.flags.xdt_evap2_HF_attractive == 0)% ramp fields up
...
curtime= ramp_bias_fields(calctime(curtime,0), ramp); % check ramp_bias_fields to see what struct ramp may contain 
    ...
    if (seqdata.flags.xdt_evap2_HF_attractive == 1 && seqdata.flags.xdt_evap2_HF == 0)
...
curtime= ramp_bias_fields(calctime(curtime,0), ramp); % check ramp_bias_fields to see what struct ramp may contain 
    ...
    if seqdata.flags.xdt_evap2_HF || seqdata.flags.xdt_evap2_HF_attractive == 1 %different evap times for high field or low field
...
curtime = AnalogFuncTo(calctime(curtime,0),'dipoleTrap2',...
    ...
    if (seqdata.flags.xdt_evap2_HF==1 && seqdata.flags.xdt_evap2_HF_attractive == 0 && seqdata.flags.xdt_high_field_a == 0) % ramp fields back down to 15G
...
curtime = AnalogFuncTo(calctime(curtime,0),'Transport FF',...
    ...
    if (seqdata.flags.xdt_evap2_HF_attractive==1 && seqdata.flags.xdt_evap2_HF == 0 && seqdata.flags.xdt_high_field_a == 0)
