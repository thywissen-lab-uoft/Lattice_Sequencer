...
AnalogFunc(calctime(curtime,0),'kitten',...
    @(t,tt,y1,y2) dI_K+z2ik(ramp_minjerk(t,tt,y1,y2)), ...
...
AnalogFunc(calctime(curtime,0),'kitten',...
    @(t,tt,y1,y2) ramp_minjerk(t,tt,y1,y2), ...
    t_cross, t_cross, ik_cross_i+dI_K,ik_cross_f,func_k);       
