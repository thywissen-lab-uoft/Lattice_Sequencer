...
INIT:
  ...
  'to binary (0FFFh = 111111111111b). Only the 0th and 8th bit are used for Rev B.
  'the rest are ignored. (bit = 1 is output, bit = 0 is input) DIGPROG1 is used 
  'for channels 0-15 and DIGPROG2 is used for channels 16-32. (Although, we refer to
  'these channels as 33-64 in the Matlab code.)
  DIGPROG1(1,0FFFh) 
  DIGPROG2(1,0FFFh) 
