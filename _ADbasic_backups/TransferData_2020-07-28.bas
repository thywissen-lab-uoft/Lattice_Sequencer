...
INIT:
  ...
  P2_DIGPROG(2,0FFFFFFFFh)
  P2_DIGPROG(3,0FFFFFFFFh)
  ...
  P2_SYNC_ENABLE(2,0FFFFFFFFh) 'For Rev E digital channels, only one bit is required
  P2_SYNC_ENABLE(3,0FFFFFFFFh) 'For Rev E digital channels, only one bit is required
