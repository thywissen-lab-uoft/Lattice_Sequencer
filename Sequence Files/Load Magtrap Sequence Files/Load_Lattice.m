...
if seqdata.flags.High_Field_Imaging
   ...
   lattice_holdtime_list =[16]; [150]; %150 sept28
...
%     mod_amp = 1.5*((1.1E-5)*(250+mod_freq/1000)^2-0.00092*(60+mod_freq/1000)+0.04);   
