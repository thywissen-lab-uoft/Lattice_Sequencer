...
seqdata.times. tof_start = curtime;
    ...
    seqdata.flags. QP_imaging = 0; %1= image out of QP, 0=image K out of XDT , 2 = image out of deep lattice with FB already off, 3 = make sure shim are off for D1 molasses
    ...
    image_atomtype = 1;  % 0 = Rb, 1 = K, 2 = Rb+K
    ...
    elseif seqdata.flags.image_loc == 1 %Science Cell
        ...
        if (seqdata.atomtype==1  || seqdata.atomtype==4)
            ...
            if img_direction == 1
                ...
                k_detuning = 41;  %QP=42, XDT=42  40   41
