...
coil_offset = [0 30 41 43 85 116 148 179 212 242 274 338 360 360 360 360 360 360 360]; %338
%coil_offset = [0 30 41 43 85 116 148 179 212 242 274 338 360 360 358 360 359 361 360]; rev1 


if use_splines
    coil_offset(12:end) = 0; %coil_offset(12:end) = 0;
     %coil_offset(12) = 1;
end
    ...
    function y = channel_current(channel,pos,offset,width,coilrange)
        ...
        switch channel
            ...
            case 1  %This is the FF channel
                 ...
                 beginningverticalvoltage = 10.0/6.6; %11/4 %12/4
                 
                 
                 %ramp up vertical transport coil
                 maxverticalvoltage = 9.5/6.6; %11.5/4  %14.5
                 ...
                 endverticalvoltage = 10.0/6.6; %12/4  %10/4
                 %------------------------
...
%                  y(ind) = y(ind) + initial_voltage.*(pos(ind)<position1_start);
%                  
%                  %ramp1
