...
defVar('xdt_evap1_power',0.12,'W');0.14;
...
freq_offset_notilt_list = freq_offset_tilt_list+150;%df = +150, measured 03/03/25, df = +130, measured 01/23/2025, df=+100 with phase stab [276,256]
% defVar('tilt_notilt_shift',[130],'kHz');
