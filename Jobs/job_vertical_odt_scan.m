...
out.WaitMode = 2;
out.WaitTime = 90;
out.JobName         = ['scan vertical ODT disp, ' 'Beams ' num2str([ODT1_onebeam ODT2_onebeam]) ', Ramps ' num2str([ODT1_vert_ramp ODT2_vert_ramp]) ', Lattice Load ' num2str(lattice_load_depth) 'ER, evap ' num2str(1e3*0.0545) ' mW, '  num2str(201.1) ' G' ];
