...
%Set the High field imaging flags
seqdata.flags.HF_absorption_image.use_K_OP = 0;
seqdata.flags.HF_absorption_image.negative_imaging_shim = 'negative'; 
seqdata.flags.HF_absorption_image.image_atomtype = 'K';
seqdata.flags.HF_absorption_image.img_direction = 'X';

%Load in the absorption imaging parameters.
seqdata.params.HF_absorption_image = Load_Absorption_Image_Parameters(); 
