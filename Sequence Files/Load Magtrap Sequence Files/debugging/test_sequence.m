...
% DigitalPulse(calctime(curtime,0),'PA TTL',0.1,1);
...
% 
%     
%     DigitalPulse(calctime(curtime,0),'QPD Monitor Trigger',3,1);
%     curtime = calctime(curtime,250);
% % 
% 
% 
...
%             @(t,tt,y1,y2) ODT2_CTRL_2_V(ramp_minjerk(t,tt,y1,y2)), ...
%             100,100,V_C,V_CTRL_1);
...
%             @(t,tt,y1,y2) ODT1_CTRL_2_V(ramp_minjerk(t,tt,y1,y2)), ...
%             100,100,V_C,V_CTRL_1);
% AnalogFunc(calctime(curtime,0),'ODT1 Piezo HV',...
%             @(t,tt,y1,y2) ODT1_CTRL_2_HV(ramp_minjerk(t,tt,y1,y2)), ...
%             100,100,V_C,V_CTRL_1);
%         
%         
% curtime=calctime(curtime,100);
...
% %         100,100,5,5+dV1,1); 
% %     
% % curtime = AnalogFunc(calctime(curtime,0),'XDT1 V Piezo',...
% %         @(t,tt,y1,y2)(ramp_linear(t,tt,y1,y2)),...
% %         100,100,5,0,1);  
% %     
% %     
...
% % AnalogFunc(calctime(curtime,0),'ODT2 Piezo HV',...
% %         @(t,tt,y1,y2)(ramp_linear(t,tt,y1,y2)),...
% %         200,200,5+dV2,5-dV2,1);      
% % AnalogFunc(calctime(curtime,0),'ODT1 Piezo HV',...
% %         @(t,tt,y1,y2)(ramp_linear(t,tt,y1,y2)),...
% %         200,200,5+dV1,5-dV1,1); 
% % curtime = AnalogFunc(calctime(curtime,0),'XDT1 V Piezo',...
% %         @(t,tt,y1,y2)(ramp_linear(t,tt,y1,y2)),...
% %         200,200,0,10,1);  
% % 
...
% % %     @(t,tt,y1,y2)(ramp_minjerk(t,tt,y1,y2)), ...
% % %     25,25,0.040);
% % curtime = AnalogFunc(calctime(curtime,0),'XDT2 V Piezo',...
% %         @(t,tt,y1,y2)(ramp_linear(t,tt,y1,y2)),...
% %         20,20,0,9,1);
% % % curtime = AnalogFunc(calctime(curtime,0),'Modulation Ramp',...
% % %     @(t,tt,y1,y2)(ramp_linear(t,tt,y1,y2)),...
...
% % % curtime = calctime(curtime,50);
% 
% curtime = xdt_piezo_scramble(curtime);
% 
% 
% % Ramp on XDTs
% AnalogFuncTo(calctime(curtime,0),'dipoleTrap1',...
