...
%     %201G:-0.5 %190G: -0.25 180G: -1.35 %195G: -0.75
%     params.detunings.K.X.negative9.HF.normal = -7 + kHFdet_shift;
    
    params.detunings.K.X.negative9.HF.SG = -4.5; %
    
    params.detunings.K.X.negative7.HF.normal = 9.25 +0.3; %201G:+0.3 %190G: -0.25 %180G: -2.53 %195G: 0
