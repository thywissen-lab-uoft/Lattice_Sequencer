...
%Author: Dylan
%Created: Oct 2012
%Summary: Weaken QP Trap for gradient seperation
%------
function [timeout I_QP V_QP] = SG_weak_QP_trap(timein, I_QP, V_QP, weak_QP)
...
%% Ramp the QP Down
    ...
    QP_ramp_percent = 0.08; %0.25
    qp_ramp_down_time1 = 5;
