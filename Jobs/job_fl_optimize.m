...
str_raman_power = ['raman optimize : plane=' num2str(plane_shift) ',' ...
    'field=' num2str(field) ',' ...
    'evap2=' num2str(evap_depth_fl)];

str_raman_detuning = ['raman detune optimize : plane=' num2str(plane_shift) ',' ...
    'field=' num2str(field) ',' ...
    'evap2=' num2str(evap_depth_fl)];
...
out_raman_pow.JobName         = str_raman_power;
out_raman_pow.SaveDir         = 'fidelity optimize raman power';  

%% Raman Detuning Function
% v1 = [0.2:.2:1.0];
% v2 = [0.2:.2:1.0];
% [vv1,vv2] = meshgrid(v1,v2);
% vv1=vv1(:);
