...
%kitten or no kitten
use_kitten = 2;  %0: no kitten, 1: kitten, 2: coil 15 h-bridge
    ...
    function y = channel_current(channel,pos,offset,width,coilrange)
        ...
        switch channel
            ...
            case 1  %This is the FF channel
                 ...
                 maxverticalvoltage = 8.0/6.6; %11.5/4  %14.5 %9.5
                 ...
                 endverticalvoltage = 8.0/6.6; %12/4  %10
                 %------------------------
